...
static int ap_add_pos_argument(char* name, arg_type type, char* help);


static arg_value get_arg(char* name);


static void ap_parse_args(int argc, char* argv[]);


static void ap_set_program_description(char* dsc);


static void ap_set_program_title(char* name);


static void ap_print_help();


static void ap_set_rule(char* arg1, arg_rule rule, char* arg2);
...
{
    Argparser ap;
    ap.add_opt_argument = ap_add_opt_argument;
    ap.add_pos_argument = ap_add_pos_argument;
    ap.arg = get_arg;
    ap.parse_args = ap_parse_args;
    ap.set_program_description = ap_set_program_description;
    ap.set_program_title = ap_set_program_title;
    ap.print_help = ap_print_help;
    ap.set_rule = ap_set_rule;
    return ap;
}
